...
/**
 * Represents the root container for Youtube media content hierarchy.
 */
public class Rygel.YoutubeRootContainer : MediaContainer {
    private ArrayList<MediaItem> items;

    public YoutubeRootContainer (string title) {
        base.root (title, 0);

        this.items = new ArrayList<MediaItem> ();
        this.items.add (new YoutubeAudioItem ("sinewave",
                                           this,
                                           "Sine Wave"));
        this.items.add (new YoutubeVideoItem ("smtpe",
                                           this,
                                           "SMTPE"));
