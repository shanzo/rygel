...
/**
 * Represents Youtube audio item.
 */
public class Rygel.YoutubeAudioItem : Rygel.YoutubeItem {
    const string TEST_MIMETYPE = "audio/x-wav";

    public YoutubeAudioItem (string         id,
    ...
    public override Element? create_stream_source () {
        ...
        dynamic Element src = ElementFactory.make ("audioyoutubesrc", null);
