...
/**
 * Represents Youtube video item.
 */
public class Rygel.YoutubeVideoItem : Rygel.YoutubeItem {
    const string TEST_MIMETYPE = "video/mpeg";

    public YoutubeVideoItem (string         id,
    ...
    public override Element? create_stream_source () {
        ...
        dynamic Element src = ElementFactory.make ("videoyoutubesrc", null);
